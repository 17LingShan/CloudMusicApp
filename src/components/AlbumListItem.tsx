...
const style = StyleSheet.create({
  ...
  container: { flex: 1, paddingHorizontal: 5, flexDirection: 'row' },
  imgWrap: { width: 60, height: '100%' },
  imgContainer: { width: '100%', height: '100%', borderRadius: 6 },
  infoWrap: {
    flex: 1,
  ...
  nameStyle: { fontSize: 16, lineHeight: 30 },
  countStyle: { fontSize: 16, opacity: 0.7, lineHeight: 30 }
})
